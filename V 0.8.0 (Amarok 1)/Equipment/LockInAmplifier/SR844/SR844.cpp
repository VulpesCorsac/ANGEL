...
{
    return this->srs->setConnection(&this->serial, portName, new_baudrate, 1, 1); // TOCHANGE
}
...
bool SR844::isValidInternalFrequency(const double &new_frequency) const
{
...
bool SR844::setReferenceSource(const int &new_source) const
{
...
bool SR844::setReferenceSource(const QString &new_source) const
{
...
bool SR844::setReferenceTriggerOutputZ(const int &new_referenceTriggerOutputZ) const
{
    if (!isValidNumber(this->referenceTriggerOutputZList, new_referenceTriggerOutputZ))
        return false;

    QString command = "REFZ " + QString::number(new_referenceTriggerOutputZ);
    return sendCommand(command);
}

bool SR844::setReferenceTriggerOutputZ(const QString &new_referenceTriggerOutputZ) const
{
    return setReferenceTriggerOutputZ(refTriggerOutputZNumberFromString(new_referenceTriggerOutputZ));
}
...
bool SR844::setWideReserveMode(const int &new_wideReserveMode) const
{
    if (!isValidNumber(this->wideReserveModeList, new_wideReserveMode))
        return false;

    QString command = "WRSV " + QString::number(new_wideReserveMode);
    return sendCommand(command);
}

bool SR844::setWideReserveMode(const QString &new_wideReserveMode) const
{
    return setWideReserveMode(wideReserveModeNumberFromString(new_wideReserveMode));
}
...
bool SR844::setSignalInputZ(const int &new_signalInputZ) const
{
    if (!isValidNumber(this->signalInputZList, new_signalInputZ))
        return false;

    QString command = "INPZ " + QString::number(new_signalInputZ);
    return sendCommand(command);
}

bool SR844::setSignalInputZ(const QString &new_signalInputZ) const
{
    return setSignalInputZ(signalInputZNumberFromString(new_signalInputZ));
}
...
bool SR844::setSensivity(const int &new_sensivity) const
{
...
bool SR844::setSensivity(const QString &new_sensivity) const
{
...
bool SR844::setCloseReserveMode(const int &new_closeReserveMode) const
{
    if (!isValidNumber(this->closeReserveModeList, new_closeReserveMode))
        return false;

    QString command = "CRSV " + QString::number(new_closeReserveMode);
    return sendCommand(command);
}

bool SR844::setCloseReserveMode(const QString &new_closeReserveMode) const
{
    return setCloseReserveMode(closeReserveModeNumberFromString(new_closeReserveMode));
}
...
bool SR844::setTimeConstant(const int &new_timeConstant) const
{
...
bool SR844::setTimeConstant(const QString &new_timeConstant) const
{
...
bool SR844::setFilter(const int &new_filter) const
{
...
bool SR844::setFilter(const QString &new_filter) const
{
...
bool SR844::setSampleRate(const int &new_sampleRate) const
{
...
bool SR844::setSampleRate(const QString &new_sampleRate) const
{
...
bool SR844::setBufferMode(const int &new_bufferMode) const
{
...
bool SR844::setBufferMode(const QString &new_bufferMode) const
{
