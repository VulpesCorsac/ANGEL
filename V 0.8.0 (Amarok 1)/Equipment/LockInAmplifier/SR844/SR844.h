...
public:
    ...
    explicit SR844(const QString &portName, const int &new_baudrate);
    ~SR844();
    ...
    bool setReferenceTriggerOutputZ(const int &new_referenceTriggerOutputZ) const;
    bool setReferenceTriggerOutputZ(const QString &new_referenceTriggerOutputZ) const;
