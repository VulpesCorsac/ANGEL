...
bool DS345::setConnection(const QString &portName, const int &baudrate, const int &stopBit, const int &parity)
{
...
void DS345::setAttemptsToConnect(const int &new_attemptsToConnect)
{
    return this->setAttemptsToConnect(new_attemptsToConnect);
}

int DS345::getAttemptsToConnect() const
{
...
bool DS345::isValidAmplitude(const double &amplitude, const QString &waveform, const QString &unit) const
{
...
bool DS345::setAmplitude(const double &amplitude, const QString &unit) const
{
    if (!isValidAmplitudeType(unit))
        return false;

    QString command = "AMPL " + QString::number(amplitude) + "" + unit;
...
bool DS345::isValidFrequency(const double &frequency, const QString &waveform) const
{
...
bool DS345::setAMdepth(const int &persentage) const
{
    ...
    QString command = "DPTH " + QString::number(persentage);
    return sendCommand(command);
}
...
{
    QString command = "FDEV " + QString::number(span);
    return sendCommand(command);
}
...
bool DS345::setModulationFunction(const int &function) const
{
    ...
    QString command = "MDWF " + QString::number(function);
    return sendCommand(command);
}

bool DS345::setModulationFunction(const QString &function) const
{
...
bool DS345::setModulationType(const int &type) const
{
    ...
    QString command = "MTYP " + QString::number(type);
    return sendCommand(command);
}

bool DS345::setModulationType(const QString &type) const
{
...
bool DS345::setModulationRate(const double &rate) const
{
    ...
    QString command = "RATE " + QString::number(rate);
    return sendCommand(command);
...
{
    QString command = "SPAN " + QString::number(span);
    return sendCommand(command);
}
