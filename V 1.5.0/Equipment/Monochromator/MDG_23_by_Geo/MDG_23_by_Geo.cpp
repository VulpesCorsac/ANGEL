...
bool MDG_23_by_Geo::setConnection(const QString &portName, int new_waitTimeout)
{
    return this->stepMotor->setConnection(portName, new_waitTimeout);
}

bool MDG_23_by_Geo::disconnect()
{
    return this->stepMotor->disconnect();
}
