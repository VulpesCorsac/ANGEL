...
public:
    ...
    SMSD_4_2* getMDG23ByGeoStepMotorController() const;
    void setMDG23ByGeoStepMotorController(SMSD_4_2 *stepMotorController);

    bool setMDG23ByGeoConnection(const QString &portName, int new_waitTimeout = 500);
    bool disconnectMDG23ByGeo();

    bool setMDG23ByGeoStepDenominator(const int &new_stepDenominator);
    int  getMDG23ByGeoStepDenominator() const;
